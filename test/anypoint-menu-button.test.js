import { fixture, expect, nextFrame, assert } from '@open-wc/testing';
...
describe('<anypoint-menu-button>', () => {
  async function basicFixture() {
    return (await fixture(`<anypoint-menu-button noanimations>
  ...
  describe('interactions', () => {
    ...
    it('opens when trigger is clicked', function(done) {
      ...
      element.addEventListener('dropdown-open', function() {
    ...
    it('closes when trigger is clicked again', function(done) {
      element.addEventListener('dropdown-open', function() {
        element.addEventListener('dropdown-close', function() {
    ...
    it('closes when disabled while open', function() {
      element.opened = true;
    ...
    it('does not open when disabled (click)', function() {
      element.disabled = true;
      MockInteractions.tap(trigger);
      expect(element.opened).not.to.be.equal(true);
    });

    it('does not open when disabled (open)', function() {
      element.disabled = true;
      element.open();
      expect(element.opened).not.to.be.equal(true);
    });

    it('closes on activate if closeonactivate is true', function(done) {
    ...
    it('closes on select', function(done) {
      element.addEventListener('dropdown-open', function() {
        element.addEventListener('dropdown-close', function() {
          done();
        });
    ...
    it('does not close on select when ignoreSelect is set', function(done) {
  ...
  describe('multiple buttons', () => {
    ...
    it('closes current and opens other', function(done) {
      ...
      element.addEventListener('iron-overlay-opened', function() {
        ...
        other.addEventListener('dropdown-open', function() {
          secondOpened = true;
        });
        setTimeout(function() {
